...
#-All Facilities-#
HUC10_discharge(HUC10,ECHO.test,"All Reporting Facilities in All Sectors")
#-Fully Matched Facilities-#
HUC10_discharge(HUC10_matched,ECHO.test_matched,"Matched Facilities in All Sectors")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_discharge(HUC10_energy,ECHO.test_energy,"Energy Facilities")
HUC10_discharge(HUC10_ag,ECHO.test_ag,"Agriculture/Irrigation Facilities")
HUC10_discharge(HUC10_commercial,ECHO.test_commercial,"Commercial Facilities")
HUC10_discharge(HUC10_industrial,ECHO.test_industrial,"Industrial Facilities")
HUC10_discharge(HUC10_municipal,ECHO.test_municipal,"Municipal Facilities")

#-Fully Matched Facilities-#
HUC10_discharge(HUC10_match_energy,ECHO.test_match_energy,"Matched Energy Facilities")
HUC10_discharge(HUC10_match_ag,ECHO.test_match_ag,"Matched Agriculture/Irrigation Facilities")
HUC10_discharge(HUC10_match_commercial,ECHO.test_match_commercial,"Matched Commercial Facilities")
HUC10_discharge(HUC10_match_industrial,ECHO.test_match_industrial,"Matched Industrial Facilities")
HUC10_discharge(HUC10_match_municipal,ECHO.test_match_municipal,"Matched Municipal Facilities")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_discharge(HUC10_nonenergy,ECHO.test_nonenergy,"Non-Energy Facilities")

#-Fully Matched Facilities-#
HUC10_discharge(HUC10_nonenergy,ECHO.test_match_nonenergy,"Matched Non-Energy Facilities")
...
#-All Facilities-#
HUC10_withdrawal(HUC10,VWUDS.test,"All Reporting Facilities in All Sectors")
#-Fully Matched Facilities-#
HUC10_withdrawal(HUC10_matched,VWUDS.test_matched,"Matched Facilities in All Sectors")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_withdrawal(HUC10_energy,VWUDS.test_energy,"Energy Facilities")
HUC10_withdrawal(HUC10_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities")
HUC10_withdrawal(HUC10_commercial,VWUDS.test_commercial,"Commercial Facilities")
HUC10_withdrawal(HUC10_industrial,VWUDS.test_industrial,"Industrial Facilities")
HUC10_withdrawal(HUC10_municipal,VWUDS.test_municipal,"Municipal Facilities")

#-Fully Matched Facilities-#
HUC10_withdrawal(HUC10_match_energy,VWUDS.test_match_energy,"Matched Energy Facilities")
HUC10_withdrawal(HUC10_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities")
HUC10_withdrawal(HUC10_match_commercial,VWUDS.test_match_commercial,"Matched Commercial Facilities")
HUC10_withdrawal(HUC10_match_industrial,VWUDS.test_match_industrial,"Matched Industrial Facilities")
HUC10_withdrawal(HUC10_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_withdrawal(HUC10_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities")

#-Fully Matched Facilities-#
HUC10_withdrawal(HUC10_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities")
...
#-All Facilities-#
HUC10_consumption(HUC10,ECHO.test,VWUDS.test,"All Reporting Facilities in All Sectors")
#-Fully Matched Facilities-#
HUC10_consumption(HUC10_matched,ECHO.test_matched,VWUDS.test_matched,"Matched Facilities in All Sectors")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_consumption(HUC10_energy,ECHO.test_energy,VWUDS.test_energy,"Energy Facilities")
HUC10_consumption(HUC10_ag,ECHO.test_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities")
HUC10_consumption(HUC10_commercial,ECHO.test_commercial,VWUDS.test_commercial,"Commercial Facilities")
HUC10_consumption(HUC10_industrial,ECHO.test_industrial,VWUDS.test_industrial,"Industrial Facilities")
HUC10_consumption(HUC10_municipal,ECHO.test_municipal,VWUDS.test_municipal,"Municipal Facilities")

#-Fully Matched Facilities-#
HUC10_consumption(HUC10_match_energy,ECHO.test_match_energy,VWUDS.test_match_energy,"Matched Energy Facilities")
HUC10_consumption(HUC10_match_ag,ECHO.test_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities")
HUC10_consumption(HUC10_match_commercial,ECHO.test_match_commercial,VWUDS.test_match_commercial,"Matched Commercial Facilities")
HUC10_consumption(HUC10_match_industrial,ECHO.test_match_industrial,VWUDS.test_match_industrial,"Matched Industrial Facilities")
HUC10_consumption(HUC10_match_municipal,ECHO.test_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_consumption(HUC10_nonenergy,ECHO.test_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities")
...
#-All Facilities-#
HUC10_consumption_nopnt(HUC10,"All Reporting Facilities in All Sectors")
#-Fully Matched Facilities-#
HUC10_consumption_nopnt(HUC10_matched,"Matched Facilities in All Sectors")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_consumption_nopnt(HUC10_energy,"Energy Facilities")
HUC10_consumption_nopnt(HUC10_ag,"Agriculture/Irrigation Facilities")
HUC10_consumption_nopnt(HUC10_commercial,"Commercial Facilities")
HUC10_consumption_nopnt(HUC10_industrial,"Industrial Facilities")
HUC10_consumption_nopnt(HUC10_municipal,"Municipal Facilities")

#-Fully Matched Facilities-#
HUC10_consumption_nopnt(HUC10_match_energy,"Matched Energy Facilities")
HUC10_consumption_nopnt(HUC10_match_ag,"Matched Agriculture/Irrigation Facilities")
HUC10_consumption_nopnt(HUC10_match_commercial,"Matched Commercial Facilities")
HUC10_consumption_nopnt(HUC10_match_industrial,"Matched Industrial Facilities")
HUC10_consumption_nopnt(HUC10_match_municipal,"Matched Municipal Facilities")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_consumption_nopnt(HUC10_nonenergy,"Non-Energy Facilities")

#-Fully Matched Facilities-#
HUC10_consumption_nopnt(HUC10_nonenergy,"Matched Non-Energy Facilities")
...
MK_HUC10_Compile<- function(ECHO_2010_2017,VWUDS_2010_2017,label){
  ...
  save(TS_CU_HUC10,file=paste0("G:/My Drive/ECHO NPDES/USGS_Consumptive_Use_Updated/Code/R Workspaces/",label,".RData"))
