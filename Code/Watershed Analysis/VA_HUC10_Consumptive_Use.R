...
all_discharge<- function(discharge_db,label){
  ...
  HUC10_Discharges<-Facility_Discharges%>%
    dplyr::group_by(HUC10Name,Year)%>%
    dplyr::summarise(HUC10=first(HUC10),
                     Discharge_MGD=sum(Discharges_MGD,na.rm=T))
...
#--Agriculture--#
ag.HUC10_discharge_withdrawal<- function(HUC10_Withdrawals_db,label){
  #---Year 2010----#
  HUC10@data$Withdrawals_2010<-ifelse(HUC10@data$HUC10%in%HUC10_Withdrawals_db$HUC10[HUC10_Withdrawals_db$Year=="2010"],HUC10_Withdrawals_db$Withdrawals_MGD[HUC10_Withdrawals_db$Year=="2010"][match(HUC10@data$HUC10,HUC10_Withdrawals_db$HUC10[HUC10_Withdrawals_db$Year=="2010"])],NA)
...
ag.HUC10_discharge_withdrawal(HUC10_Withdrawals_ag,"_ag")
...
HUC10_discharge_withdrawal(HUC10_Discharges_match_aq,HUC10_Withdrawals_match_aq,"_match_aq")
...
rm(HUC10_Discharges,HUC10_Discharges_commercial,HUC10_Discharges_energy,HUC10_Discharges_industrial,HUC10_Discharges_match_ag,
...
NWB_CU.ag<- function(HUC10_db,label){
  #---Year 2010----#
  
  HUC10_db@data$NetWB_2010<- -(ifelse(is.na(HUC10_db@data$Withdrawals_2010),0,HUC10_db@data$Withdrawals_2010))
  HUC10_db@data$NetWB_2010<-ifelse(is.na(HUC10_db@data$Withdrawals_2010),NA,HUC10_db@data$NetWB_2010)
  
  HUC10_db@data$Consumption_2010<-(ifelse(is.na(HUC10_db@data$Withdrawals_2010),0,HUC10_db@data$Withdrawals_2010))/(ifelse(is.na(HUC10_db@data$Withdrawals_2010),0,HUC10_db@data$Withdrawals_2010))
  HUC10_db@data$Consumption_2010<-ifelse(is.nan(HUC10_db@data$Consumption_2010)|is.infinite(HUC10_db@data$Consumption_2010),NA,HUC10_db@data$Consumption_2010)
  #---Year 2011----#
  
  HUC10_db@data$NetWB_2011<- -(ifelse(is.na(HUC10_db@data$Withdrawals_2011),0,HUC10_db@data$Withdrawals_2011))
  
  HUC10_db@data$NetWB_2011<-ifelse(is.na(HUC10_db@data$Withdrawals_2011),NA,HUC10_db@data$NetWB_2011)
  
  HUC10_db@data$Consumption_2011<-(ifelse(is.na(HUC10_db@data$Withdrawals_2011),0,HUC10_db@data$Withdrawals_2011))/(ifelse(is.na(HUC10_db@data$Withdrawals_2011),0,HUC10_db@data$Withdrawals_2011))
  
  HUC10_db@data$Consumption_2011<-ifelse(is.nan(HUC10_db@data$Consumption_2011)|is.infinite(HUC10_db@data$Consumption_2011),NA,HUC10_db@data$Consumption_2011)
  
  #---Year 2012----#
  
  HUC10_db@data$NetWB_2012<- -(ifelse(is.na(HUC10_db@data$Withdrawals_2012),0,HUC10_db@data$Withdrawals_2012))
  
  HUC10_db@data$NetWB_2012<-ifelse(is.na(HUC10_db@data$Withdrawals_2012),NA,HUC10_db@data$NetWB_2012)
  
  HUC10_db@data$Consumption_2012<-(ifelse(is.na(HUC10_db@data$Withdrawals_2012),0,HUC10_db@data$Withdrawals_2012))/(ifelse(is.na(HUC10_db@data$Withdrawals_2012),0,HUC10_db@data$Withdrawals_2012))
  
  HUC10_db@data$Consumption_2012<-ifelse(is.nan(HUC10_db@data$Consumption_2012)|is.infinite(HUC10_db@data$Consumption_2012),NA,HUC10_db@data$Consumption_2012)
  #---Year 2013----#
  HUC10_db@data$NetWB_2013<- -(ifelse(is.na(HUC10_db@data$Withdrawals_2013),0,HUC10_db@data$Withdrawals_2013))
  
  HUC10_db@data$NetWB_2013<-ifelse(is.na(HUC10_db@data$Withdrawals_2013),NA,HUC10_db@data$NetWB_2013)
  
  HUC10_db@data$Consumption_2013<-(ifelse(is.na(HUC10_db@data$Withdrawals_2013),0,HUC10_db@data$Withdrawals_2013))/(ifelse(is.na(HUC10_db@data$Withdrawals_2013),0,HUC10_db@data$Withdrawals_2013))
  HUC10_db@data$Consumption_2013<-ifelse(is.nan(HUC10_db@data$Consumption_2013)|is.infinite(HUC10_db@data$Consumption_2013),NA,HUC10_db@data$Consumption_2013)
  
  #---Year 2014----#
  
  #---Without Transfers---#
  HUC10_db@data$NetWB_2014<- -(ifelse(is.na(HUC10_db@data$Withdrawals_2014),0,HUC10_db@data$Withdrawals_2014))
  
  HUC10_db@data$NetWB_2014<-ifelse(is.na(HUC10_db@data$Withdrawals_2014),NA,HUC10_db@data$NetWB_2014)
  
  HUC10_db@data$Consumption_2014<-(ifelse(is.na(HUC10_db@data$Withdrawals_2014),0,HUC10_db@data$Withdrawals_2014))/(ifelse(is.na(HUC10_db@data$Withdrawals_2014),0,HUC10_db@data$Withdrawals_2014))
  
  HUC10_db@data$Consumption_2014<-ifelse(is.nan(HUC10_db@data$Consumption_2014)|is.infinite(HUC10_db@data$Consumption_2014),NA,HUC10_db@data$Consumption_2014)
  #---Year 2015----#
  
  #---Without Transfers---#
  HUC10_db@data$NetWB_2015<- -(ifelse(is.na(HUC10_db@data$Withdrawals_2015),0,HUC10_db@data$Withdrawals_2015))
  
  HUC10_db@data$NetWB_2015<-ifelse(is.na(HUC10_db@data$Withdrawals_2015),NA,HUC10_db@data$NetWB_2015)
  
  HUC10_db@data$Consumption_2015<-(ifelse(is.na(HUC10_db@data$Withdrawals_2015),0,HUC10_db@data$Withdrawals_2015))/(ifelse(is.na(HUC10_db@data$Withdrawals_2015),0,HUC10_db@data$Withdrawals_2015))
  ...
  #---Without Transfers---#
  HUC10_db@data$NetWB_2016<- -(ifelse(is.na(HUC10_db@data$Withdrawals_2016),0,HUC10_db@data$Withdrawals_2016))
  
  HUC10_db@data$NetWB_2016<-ifelse(is.na(HUC10_db@data$Withdrawals_2016),NA,HUC10_db@data$NetWB_2016)
  
  HUC10_db@data$Consumption_2016<-(ifelse(is.na(HUC10_db@data$Withdrawals_2016),0,HUC10_db@data$Withdrawals_2016))/(ifelse(is.na(HUC10_db@data$Withdrawals_2016),0,HUC10_db@data$Withdrawals_2016))
...
NWB_CU.ag(HUC10_ag,"_ag")

#-Fully Matched Facilities-#
NWB_CU(HUC10_match_energy,"_match_energy")
NWB_CU(HUC10_match_aq,"_match_aq")
...
Ave_NWB_CU.ag<- function(HUC10_db,label){
  
  #----Withdrawals----#
  HUC10_db@data$Withdrawal_ave<-apply(HUC10_db@data[,c("Withdrawals_2010","Withdrawals_2011","Withdrawals_2012",
                                                     "Withdrawals_2013","Withdrawals_2014","Withdrawals_2015",
                                                     "Withdrawals_2016")],1,median,na.rm=T)
  
  #----Consumption----#
  HUC10_db@data$Consumption_ave<-apply(HUC10_db@data[,c("Consumption_2010","Consumption_2011","Consumption_2012",
                                                      "Consumption_2013","Consumption_2014","Consumption_2015",
                                                      "Consumption_2016")],1,median,na.rm=T)
  
  HUC10_db@data$Consumption_ave<-ifelse(is.infinite(HUC10_db@data$Consumption_ave),NA,HUC10_db@data$Consumption_ave)
...
Ave_NWB_CU.ag(HUC10_ag,"_ag")

#-Fully Matched Facilities-#
Ave_NWB_CU(HUC10_match_energy,"_match_energy")
Ave_NWB_CU(HUC10_match_aq,"_match_aq")
...
HUC10_discharge<- function(HUC10_db,ECHO_points, label,fileext){
  
  HUC10_Clipped<-gIntersection(HUC10_db,VA,id=as.character(HUC10_db@data$HUC10),byid=TRUE,drop_lower_td=TRUE)
  HUC10_Clipped<-SpatialPolygonsDataFrame(HUC10_Clipped,HUC10_db@data[as.character(HUC10_db@data$HUC10)%in%names(HUC10_Clipped),],match.ID = "HUC10")
  ...
  plot1<-ggplot()+
    ...
    scale_fill_manual(name="Discharge by HUC10 (MGD)", values=(Dis_Discrete), 
                      labels=c(paste("<",1),
                               paste(1,"-",5),
                               paste(5,"-",10),
                               paste(10,"-",25),
...
#-All Facilities-#
HUC10_discharge(HUC10_all,ECHO.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
...
HUC10_discharge(HUC10_aq,ECHO.test_aq,"Aquaculture Facilities","all_aq")
...
discharge_subplot_all<- function(){
  ...
  ggexport(filename=paste0(path,"HUC10_Dis_All_Subplot.pdf"), plot=subplot, width=13.33, height=6.66,units="in")
...
HUC10_discharge(HUC10_match_aq,ECHO.test_match_aq,"Matched Aquaculture Facilities","match_aq")
HUC10_discharge(HUC10_match_commercial,ECHO.test_match_commercial,"Matched Commercial Facilities","match_commercial")
...
discharge_subplot_match<- function(){
  ...
  ggexport(filename=paste0(path,"HUC10_Dis_Matched_Subplot.pdf"), plot=subplot, width=13.33, height=6.66,units="in")
...
HUC10_withdrawal<- function(HUC10_db,VWUDS_points,label,fileext){
  ...
  plot1<-ggplot()+
    ...
    scale_fill_manual(name="Withdrawal by HUC10 (MGD)", values=(With_Discrete),
                      labels=c(paste("<",1),
                               paste(1,"-",5),
                               paste(5,"-",10),
                               paste(10,"-",25),
...
#-All Facilities-#
HUC10_withdrawal(HUC10_all,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
...
HUC10_withdrawal(HUC10_aq,VWUDS.test_aq,"Aquaculture Facilities","all_aq")
...
withdrawal_subplot_all<- function(){
  ...
  ggexport(filename=paste0(path,"HUC10_With_All_Subplot.pdf"), plot=subplot, width=13.33, height=6.66,units="in")
...
HUC10_withdrawal(HUC10_match_aq,VWUDS.test_match_aq,"Matched Aquaculture Facilities","match_aq")
...
withdrawal_subplot_match<- function(){
  ...
  ggexport(filename=paste0(path,"HUC10_With_Matched_Subplot.pdf"), plot=subplot, width=13.33, height=6.66,units="in")
...
HUC10_consumption<- function(HUC10_db, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption(HUC10_all,ECHO.test,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sector")
...
HUC10_consumption(HUC10_nonenergy,ECHO.test_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities","HUC10_all_nonenergy")
HUC10_consumption(HUC10_energy,ECHO.test_energy,VWUDS.test_energy,"Energy Facilities","all_energy")

HUC10_consumption_ag<- function(HUC10_db,VWUDS_points, label,fileext){
  ...
  plot1<-ggplot()+
    geom_polygon(
      data=HUC10.df,
      aes(x=long, y= lat, group=group,
          fill=cut(HUC10.df$Consumption_ave,breaks=c(0,0.25,0.5,0.75,1),include.lowest=T),colour=""))+
    scale_fill_manual(name="Consumption Coefficient", values=CU_Discrete, 
                      labels=c(
                        paste(0,"-",0.25),
                        paste(0.25,"-",0.5),
                        ...
                        paste(0.75,"-",1)),
                      na.value="transparent", drop=FALSE)+
    geom_polygon(data=HUC10.df,aes(x=long, y= lat, group=group),colour="#252525",fill="transparent")+
    scale_colour_manual(values=NA)+
    # scale_shape_manual(name="", values=17)+
    # geom_point(data=VWUDS_points, aes(x=VWUDS.Long, y=VWUDS.Lat, size="VWUDS Facility"),colour="#252525")+
    # scale_size_manual(name="", values=3.0)+
  ...
  #ggsave(filename=paste0(path,"HUC10_CU_",fileext,".pdf"), plot=plot1, width=13.33, height=6.66,units="in")
  
  return(list(plot1))
  
}
HUC10_consumption_ag(HUC10_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities","all_ag")

HUC10_consumption_aq<- function(HUC10, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption_aq(HUC10_aq,ECHO.test_aq,VWUDS.test_aq,"Aquaculture Facilities","all_aq")
...
all_subplot<- function(){
  ...
  ggexport(filename=paste0(path,"HUC10_CU_All_Subplot.pdf"), plot=subplot, width=13.33, height=6.66,units="in")
...
HUC10_consumption(HUC10_match_nonenergy,ECHO.test_match_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities","HUC10_match_nonenergy")

HUC10_consumption_aq<- function(HUC10_db, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption_aq(HUC10_match_aq,ECHO.test_match_aq,VWUDS.test_match_aq,"Matched Aquaculture Facilities","match_aq")
...
matched_subplot<- function(){
  ...
  subplot<-ggpubr::ggarrange(match_energy,match_nonenergy,match_industrial,
                             ...
                             legend="bottom",
                             ncol=2,nrow=3)%>%annotate_figure(
                               top = text_grob("2010-2016 Median Annual HUC 10 Watershed Consumption Considering Matched Facility Data", 
                                               color = "black", face = "bold", size = 14))
  
  path="G:/My Drive/USGS_ConsumptiveUse/Spring, 2019/HUC10 Analysis/Consumption/"
  
  ggexport(filename=paste0(path,"HUC10_CU_Matched_Subplot_points.pdf"), plot=subplot, width=13.33, height=6.66,units="in")
...
#--Aquaculture--#
HUC10_consumption_aquaculture<- function(HUC10_db, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption_aquaculture(HUC10_match_aq,ECHO.test_match_aq,VWUDS.test_match_aq,"Matched Aquaculture Facilities","match_aq")

#--Commercial--#
HUC10_consumption_commercial<- function(HUC10_db, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption_commercial(HUC10_match_commercial,ECHO.test_match_commercial,VWUDS.test_match_commercial,"Matched Commercial Facilities","match_commercial")

#--Industrial--#
HUC10_consumption_industrial<- function(HUC10_db, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption_industrial(HUC10_match_industrial,ECHO.test_match_industrial,VWUDS.test_match_industrial,"Matched Industrial Facilities","match_industrial")


#---Non-Energy Sectors---#
HUC10_consumption_non_energy<- function(HUC10_db, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption_non_energy(HUC10_match_nonenergy,ECHO.test_match_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")

#--Energy--#
HUC10_consumption_energy<- function(HUC10_db, ECHO_points ,VWUDS_points, label,fileext){
...
HUC10_consumption_energy(HUC10_match_energy,ECHO.test_match_energy,VWUDS.test_match_energy,"Matched Energy Facilities","match_energy")
...
#-Fully Matched Facilities-#
HUC10_consumption_nopnt(HUC10_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")
...
full_match_2010_2017_summary<-full_match_2010_2017%>%dplyr::group_by(VPDES.Facility.ID)%>%
  dplyr::summarise(VWUDS.Facility.ID=first(VWUDS.Facility.ID),OutfallID=first(OutfallID),VWUDS.Name=first(VWUDS.Name),VPDES.Name=first(VPDES.Name),
                   ...
                   Ave_Withdrawal_mgd=median(Withdrawals_MGD,na.rm=T),Ave_Discharge_mgd=median(Discharges_MGD,na.rm=T),HUC10Name=first(HUC10Name),Waterbody=first(Waterbody))
