...
The data dictionary for this script can be found [here](https://github.com/mccartma/USGS_Consumptive_Use/blob/master/Documentation/Data_Dictionaries/Codebook-for-ECHOInterface.md)
