...
png(file="Histograms.png",width=6*ppi,height=12*ppi,res=ppi)		
  ...
  par(mar=c(3,3,2,1.5))
  hist(trim.records$CU_scale[trim.records$Use.Type=="Energy"], main="Energy (Subset)", xlab="", ylab="") #12 facilities
  hist(trim.records$CU_scale[trim.records$Use.Type=="Industrial"], main="Industrial (Subset)", xlab="", ylab="") # 34 facilities
  hist(trim.records$CU_scale[trim.records$Use.Type=="Commercial"], main="Commercial (Subset)", xlab="", ylab="") # 34 facilities
  hist(trim.records$CU_scale[trim.records$Use.Type=="Aquaculture" & trim.records$CU_scale < 0.5], 
...
png(file="Histograms_R1.png",width=6*ppi,height=6*ppi,res=ppi)		
par(mfcol=c(2,2))
par(mar=c(3,4,2,1.5))
## All records
hist(match.summary$CU_scale[match.summary$Use.Type=="Energy"], main="Energy", xlab="") #13 facilities
hist(match.summary$CU_scale[match.summary$Use.Type=="Industrial"], main="Industrial", xlab="") # 46 facilities
hist(match.summary$CU_scale[match.summary$Use.Type=="Commercial"], main="Commercial", xlab="") # 48 facilities
hist(match.summary$CU_scale[match.summary$Use.Type=="Aquaculture"], main="Aquaculture", xlab="") # 8 facilities
